...
from repo_paths import (DATA_DIR, REPORTS_DIR, find_default_genome_path,
                        data_file, open_data, ensure_reports_dir)
...
def main():
    ...
    # Load PharmGKB
    pharmgkb_annotations = data_file("clinical_annotations.tsv")
    pharmgkb_alleles = data_file("clinical_ann_alleles.tsv")
